...
namespace NS_SWEETEDITOR {
  ...
  private:
    ...
    /// Map a virtual visual line to an adjacent stable document text boundary.
    TextPosition mapVirtualLineToTextBoundary(size_t logical_line, const VisualLine& visual_line) const;
