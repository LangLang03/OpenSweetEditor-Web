...
namespace NS_SWEETEDITOR {
  ...
  public:
    ...
    void buildCursorModel(EditorRenderModel& model,
                          const TextPosition& cursor_position,
                          bool has_selection,
                          float line_height) const;

    void buildCompositionDecoration(EditorRenderModel& model,
    ...
    void buildGuideSegments(EditorRenderModel& model,
                            Document* document,
                            TextMeasurer& measurer,
                            float line_height) const;

    void buildDiagnosticDecorations(EditorRenderModel& model,
                                    Document* document,
                                    float line_height) const;

    void buildBracketHighlightRects(EditorRenderModel& model,
    ...
    void buildScrollbarModel(EditorRenderModel& model,
