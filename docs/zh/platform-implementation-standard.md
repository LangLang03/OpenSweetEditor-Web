...
| `flingFriction` | float | `3.5` | fling 摩擦系数 |
| `flingMinVelocity` | float | `50.0` | fling 最小速度阈值，单位 px/s |
| `flingMaxVelocity` | float | `8000.0` | fling 最大速度上限，单位 px/s |
...
| `LongPressEvent` | `cursorPosition: TextPosition`, `locationInView: PointF 或平台原生点类型` | 原始长按命中的位置与相对 editor view 的点位 |
...
| `ContextMenuEvent` | `cursorPosition: TextPosition`, `locationInView: PointF 或平台原生点类型` | 显式 context-menu 手势命中的位置与相对 editor view 的点位 |
