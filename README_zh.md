...
> 本仓库是 [LangLang03](https://github.com/LangLang03) 维护的 **非官方 Fork 修改版**，并非 OpenSweetEditor 官方仓库。
>
> 官方上游仓库：[FinalScave/OpenSweetEditor](https://github.com/FinalScave/OpenSweetEditor)
...
| [Web 平台 API（使用指南）](docs/zh/api-platform-web.md) | Web SDK v2 的接入方式、构建流程、runtime 打包与 CDN 用法 |
| [Web SDK v2 完整 API 参考（100%）](docs/zh/api-platform-web-sdk-v2-reference.md) | 覆盖 `@sweeteditor/sdk`、`@sweeteditor/core`、`@sweeteditor/widget`、`@sweeteditor/providers-sweetline` 的完整声明 |
